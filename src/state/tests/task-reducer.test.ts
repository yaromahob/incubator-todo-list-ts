...
//
//
//   const action = changeTaskTitleAC(todolistId1, '2', 'React');
//
//   const endState = tasksReducer(startState, action);
//
//   const action2 = changeTaskTitleAC(todolistId2, '3', 'Coffee');
//   const endState2 = tasksReducer(startState, action2);
//
//   expect(endState[todolistId1][2].title).toBe('React');
//   expect(endState2[todolistId2][2].title).toBe('Coffee');
// });
//
